...
const ProjectCard = () => {
    return (
        <div className={`relative border-2 p-6 rounded min-h-80 flex flex-col justify-center items-center gap-y-4 before:rounded-br-lg before:opacity-60 before:absolute before:top-0 before:left-0 before:w-10 before:h-10 hover:before:h-full hover:before:w-full before:bg-gradient-to-r before:from-blue-500 before:via-blue-700 before:to-blue-900 cursor-pointer before:transition-all before:ease-in-out before:duration-500 group  before:z-20 overflow-hidden`}>
            <Image
