const ServiceCard = () => {
    return (
        <div className="bg-DeepNavy-blue text-light-gray p-6 rounded flex flex-col justify-center items-center gap-y-4 shadow-md shadow-black before:absolute md:before:top-0 before:left-0 before:w-full before:h-full  before:bg-[red]">
